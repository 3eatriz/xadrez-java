...
public class IU {
	...
	public static PosicaoXadrez lerPosicaoXadrez(Scanner leia) {
		try {
			...
			throw new InputMismatchException("Erro lendo a PosicaoXadrez. Os valores validos sao de a1 ate h8.");
		}
	}
	
	public static void imprimirPartida(PartidaDeXadrez partidaXadrez, List<PecaDeXadrez> capturada) {
